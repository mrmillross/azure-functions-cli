...
{
    [Action(Name = "list-functions", Context = Context.Azure, SubContext = Context.FunctionApp, HelpText = "place holder")]
    [Action(Name = "lf", Context = Context.Azure, SubContext = Context.FunctionApp, HelpText = "place holder")]
